...
FIND_FOOTER = """<div>
      ...
      <ul class=\"footer-links\">
        <li><a href=\"/#home-enquiry\">Get in Touch</a></li>
        <li><a href=\"/#home-enquiry\">Enquire about your next session</a></li>
...
def page_nav() -> str:
  ...
  <a href="/#home-enquiry" class="nav-cta">Enquire about your next session</a>
...
{MOBILE_SERVICE_LINKS}
  <a href="/#home-enquiry" class="mobile-cta">Enquire about your next session</a>
</div>'''
...
<div class="cta-band reveal"><h2 class="h2-serif">Not sure what you need?</h2><p class="body-text">Our team are always happy to talk through your project and help you plan the right session.</p><div class="btn-row"><a href="/#home-enquiry" class="btn-primary">Enquire now</a></div></div>
...
def services_accordion() -> str:
    ...
    <div class="service-content service-grid">
      <div class="service-copy"><h2>{d['headline']}</h2><p>{html_escape(d['intro'])}</p><div class="service-actions"><a href="/#home-enquiry" class="btn-primary">{html_escape(d['cta'])}</a></div><h3>What You Get</h3><ul class="service-list">{bullets}</ul><p>{html_escape(d['secondary'])}</p><h3>Why Salvation?</h3><p>{html_escape(d['why'])}</p><h3>Not sure what you need?</h3><p>Our team are always happy to talk through your project and help you plan the right session.</p><div class="service-actions"><a href="/#home-enquiry" class="btn-primary">Enquire now</a><a href="/services/{slug}/" class="btn-outline">Open service page</a></div></div>
      <div>{imgs}</div>
    </div>
  </details>''')
...
def patch_nav_footer_and_ctas(path: Path) -> None:
    ...
    if not path.name.startswith("concept-"):
        ...
        text = text.replace('href="/contact/" class="nav-cta"', 'href="/#home-enquiry" class="nav-cta"')
        text = text.replace('href="/contact/" class="mobile-cta"', 'href="/#home-enquiry" class="mobile-cta"')
        text = text.replace('href="/contact/" class="btn-primary"', 'href="/#home-enquiry" class="btn-primary"')
        text = text.replace('href="/contact/" class="btn-outline"', 'href="/#home-enquiry" class="btn-outline"')
        text = text.replace('href="/contact/">Get in Touch', 'href="/#home-enquiry">Get in Touch')
        text = text.replace('href="/contact/">Enquire about your next session', 'href="/#home-enquiry">Enquire about your next session')
        text = text.replace('href="/contact/">Enquire', 'href="/#home-enquiry">Enquire')
        text = text.replace('href="/contact/">Start an Enquiry', 'href="/#home-enquiry">Start an Enquiry')
        if path.name == "index.html":
            # Homepage CTAs should scroll to the local form.
            text = text.replace('href="/#home-enquiry" class="nav-cta"', 'href="#home-enquiry" class="nav-cta"')
            text = text.replace('href="/#home-enquiry" class="mobile-cta"', 'href="#home-enquiry" class="mobile-cta"')
            text = text.replace('href="/#home-enquiry" class="btn-primary hero-book-btn"', 'href="#home-enquiry" class="btn-primary hero-book-btn"')
            text = text.replace('href="/#home-enquiry" class="section-link"', 'href="#home-enquiry" class="section-link"')
